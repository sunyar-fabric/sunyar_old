...
const { wsCreateSettelment, wsDeleteSettelment, wsLoadCharitySettelment, wsLoadDonatorSettelment } = require('../compositeServices/settelment');
...
sunyarRouter.post('/',(req, _, next)=>{authorizeRequest(req, "ACCOUNTANT", next)},async (req, res, next) => {
    try {
...
sunyarRouter.get('/donatorSettelment',(req, _, next)=>{authorizeRequest(req, "ACCOUNTANT", next)}, async (req, res, next) => {
    try {
...
sunyarRouter.get('/charitySettelment', (req, _, next)=>{authorizeRequest(req, "ACCOUNTANT", next)}, async (req, res, next) => {
    try {
...
sunyarRouter.delete('/:paymentId', (req, _, next)=>{authorizeRequest(req, "ACCOUNTANT", next)},async (req, res, next) => {
    try {

...
const validateLoadCharityAccounts = async (body) => { 
...
const validateCreateCharityAccounts = async (body) => {
    const schema = Joi.object().keys({
...
const validateUpdateCharityAccounts = async (body) => {
...
const validateDeleteCharityAccounts = async (body) => {

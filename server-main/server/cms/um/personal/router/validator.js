...
const preventSqlInjection =
  require("../../../../utility/fnPreventSqlInjection").custom;
const preventSqlInjectionV2 =
  require("../../../../utility/fnPreventSqlInjection").customInjection;

const validateLoadPersonal = async (query, language) => {
      ...
      .custom((value, helper) => {
        if (preventSqlInjection(value)) {
          ...
          return helper.message(
            "از کاراکترهای غیر مجاز در نام شعبه استفاده نکنید"
          );
        }
      })
      .messages({
  ...
  var schemaEn = Joi.object().keys({
    ...
    name: Joi.string().min(1).max(500).allow(null, "null"),
    family: Joi.string().min(1).max(500).allow(null, "null"),
    nationalCode: Joi.string()
      .custom((value, helper) => {
        if (value) {
          value = english_digit(value);
      ...
      .messages({
        "string.base": `Invalid national code`,
      })
      .allow(null, "null"),
    idNumber: Joi.string().min(1).max(10).allow(null, "null"),
...
const validateCreatePersonal = async (body, language) => {
    ...
    name: Joi.string()
      ...
      .custom((value, helper) => {
        if (preventSqlInjection(value)) {
          ...
          return helper.message("از کاراکترهای غیر مجاز در نام استفاده نکنید");
        }
      })
      .messages({
        "string.base": `نوع ورودی نام صحیح نمی‌باشد`,
    ...
    family: Joi.string()
      ...
      .custom((value, helper) => {
        if (preventSqlInjection(value)) {
          ...
          return helper.message(
            "از کاراکترهای غیر مجاز در نام خانوادگی استفاده نکنید"
          );
        }
      })
      .messages({
    ...
    idNumber: Joi.string()
      ...
      .custom((value, helper) => {
        if (preventSqlInjection(value)) {
          ...
          return helper.message(
            "از کاراکترهای غیر مجاز در شماره شناسنامه استفاده نکنید"
          );
        }
      })
      .messages({
    ...
    birthDate: Joi.date()
      .custom((value, helper) => {
        if (preventSqlInjectionV2(value)) {
          ...
          return helper.message(
            "از کاراکترهای غیر مجاز در تاریخ استفاده نکنید"
          );
        }
      })
      .messages({
    ...
    birthPlace: Joi.string()
      ...
      .custom((value, helper) => {
        if (preventSqlInjection(value)) {
          ...
          return helper.message(
            "از کارکترهای غیر مجاز در محل تولد استفاده نکنید"
          );
        }
      })
      .messages({
  ...
  var schemaEn = Joi.object().keys({
    ...
    nationalCode: Joi.string().custom((value, helper) => {
      value = english_digit(value);
      if (value == "") return helper.message("National code required");
      if (value.length < 8 || parseInt(value, 10) == 0)
        return helper.message("Invalid national code");
      value = ("0000" + value).substr(value.length + 4 - 10);
      if (parseInt(value.substr(3, 6), 10) == 0)
    ...
    idNumber: Joi.string().min(1).max(10).allow(null, ""),
...
const validateCreateNeedy = async (body, language) => {
    ...
    name: Joi.string()
      ...
      .custom((value, helper) => {
        if (preventSqlInjection(value)) {
          ...
          return helper.message("از کارکترهای غیر مجاز در نام استفاده نکنید");
        }
      })
      .messages({
        "string.base": `نوع ورودی نام صحیح نمی‌باشد`,
    ...
    family: Joi.string()
      ...
      .custom((value, helper) => {
        if (preventSqlInjection(value)) {
          ...
          return helper.message(
            "از کارکترهای غیر مجاز در نام خانوادگی استفاده نکنید"
          );
        }
      })
      .messages({
  ...
  var schemaEn = Joi.object().keys({
    ...
    personPhoto: Joi.binary().custom((value, helper) => {
      if (value == "") {
        return helper.message("Photo is required");
      }
    }),
    secretCode: Joi.forbidden(),
  });
...
const validateUpdatePersonal = async (body, language) => {
    ...
    birthPlace: Joi.string()
      ...
      .custom((value, helper) => {
        if (preventSqlInjection(value)) {
          ...
          return helper.message(
            "از کاراکترهای غیر مجاز در مکان تولد استفاده نکنید"
          );
        }
      })
      .messages({
  ...
  var schemaEn = Joi.object().keys({
    ...
    nationalCode: Joi.string().custom((value, helper) => {
      value = english_digit(value);
      if (value.length < 8 || parseInt(value, 10) == 0)
        return helper.message("National code is not valid");
      value = ("0000" + value).substr(value.length + 4 - 10);
      if (parseInt(value.substr(3, 6), 10) == 0)
        return helper.message("National code is not valid");
      if (value.length == 10) {
...
const validateUpdateNeedy = async (body, language) => {
  var schema = Joi.object().keys({
    ...
    idNumber: Joi.string()
      ...
      .custom((value, helper) => {
        if (preventSqlInjection(value)) {
          ...
          return helper.message(
            "از کارکترهای غیر مجاز در شماره شناسنامه استفاده نکنید"
          );
        }
      })
      .messages({
    ...
    isActive: Joi.optional().messages({
      "boolean.base": `نوع ورودی فعال/غیرفعال صحیح نمی‌باشد`,
      // 'boolean.empty': `تعیین فعال/غیرفعال اجباری است`,
      "any.required": `تعیین فعال/غیرفعال اجباری است`,
    }),
  });
  var schemaEn = Joi.object().keys({
    personId: Joi.number().integer().required(),
